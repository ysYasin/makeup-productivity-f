...
const ThisWeakTask = () => {
  ...
  const [TisWeakstodos, setTisWeaksTodos] = useState([]);
  const handleTisWeaksTodoSubmite = (e) => {
    e.preventDefault();
    const form = e.target;
    ...
    setTisWeaksTodos([...TisWeakstodos, newToDo]);
    form.reset();
  };
  ...
  return (
    <div className="w-full">
      <header className="py-5 border-b w-full ">
        <h1 className="text-5xl suger font-medium">this weak</h1>
      </header>
          ...
          <div className="w-full">
            ...
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box relative">
                <form onSubmit={handleTisWeaksTodoSubmite}>
                  <input
                    name="headLine"
                    type="text"
